...
public class AdmissionFormItemClass implements Serializable {
        private String name;
        ...
        public AdmissionFormItemClass() {
            //empty constructor needed
        }

    public AdmissionFormItemClass(String name, String imgPath,int age, String dateSubmit)
    {
        this.name = name;
        this.img = imgPath;
        this.age = age;
    ...
    public AdmissionFormItemClass(String name, int age, String gender, String address, String bday, String fname, String fphno, String foccp, String fqual, String fcnic, String mname, String mphno, String moccp, String mqual, String mcnic, String info, String img, String pay, String prog, String telno, String email, String dname, String dphno, String gname, String gphno,String dateSubmit) {
        this.name = name;
        this.gender = gender;
        this.age = age;
